...
// ================= FITUR REDIRECT WHATSAPP (BASE64) =================
// Mengarah langsung ke nomor tujuan (di-encode base64, bukan enkripsi asli,
// hanya menghindari nomor tertulis polos di source code)
 ...
 */
window.klaimVoucherKeWhatsApp = function(namaHadiah, hargaPoin, existingTab) {
    if (!userUID) {
